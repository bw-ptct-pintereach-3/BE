...
describe("articles integration test", () => {
  ...
  it("POST /articles", async () => {
    ...
    expect(res.body.error).toBe(
      "The category_id must be in the range of 1 to 10."
    );
  });
...
describe("categories integration test", () => {
  it("GET /categories", async () => {
    ...
    expect(res.body[1].category).toBe("Recreation");
  });
  it("GET /categories/1", async () => {
    const res = await supertest(server)
